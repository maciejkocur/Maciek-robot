...
public class EmpikBookLinksCrawlerTest {
    ...
    public void crawlEmpikSite() throws Exception {
        ...
        assertEquals(actualUrls.get(0), "http://www.empik.com/uwiklanie-miloszewski-zygmunt,p1046125476,ebooki-i-mp3-p");
        assertEquals(actualUrls.get(1), "http://www.empik.com/gniew-miloszewski-zygmunt,p1102035963,ebooki-i-mp3-p");
        assertEquals(actualUrls.get(2), "http://www.empik.com/ziarno-prawdy-miloszewski-zygmunt,p1045554060,ebooki-i-mp3-p");
        assertEquals(actualUrls.get(39), "http://www.empik.com/piata-kobieta-mankell-henning,p1046149467,ebooki-i-mp3-p");
    }
}